...
import 'package:marketplace_entregador/app/modules/home/home_bloc.dart';
...
var titleTermTwoDescription = "O que são cookies?" +
    ...
    "Este site usa o Google Analytics, que é uma das soluções de análise mais difundidas e confiáveis ​​da Web, para nos ajudar a entender como você usa o site e como podemos melhorar sua experiência. Esses cookies podem rastrear items como quanto tempo você gasta no site e as páginas visitadas, para que possamos continuar produzindo conteúdo atraente." +
    "Para mais informações sobre cookies do Google Analytics, consulte a página oficial do Google Analytics." +
    "As análises de terceiros são usadas para rastrear e medir o uso deste site, para que possamos continuar produzindo conteúdo atrativo. Esses cookies podem rastrear items como o tempo que você passa no site ou as páginas visitadas, o que nos ajuda a entender como podemos melhorar o site para você." +
    ...
    "O usuário se compromete a fazer uso adequado dos conteúdos e da informação que o fintec oferece no site e com caráter enunciativo, mas não limitativo:" +
    ...
    "C) Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) do fintec, de seus fornecedores ou terceiros, para introduzir ou disseminar vírus informáticos ou quaisquer outros sistemas de hardware ou software que sejam capazes de causar danos anteriormente mencionados." +
    "Mais informações" +
