...
var titleTermOneDescription =
    "A sua privacidade é importante para nós. É política do matk respeitar a sua privacidade em relação a qualquer informação sua que possamos coletar no site matk, e outros sites que possuímos e operamos. " +
...
var titleTermTwoDescription = "O que são cookies?" +
    ...
    "O usuário se compromete a fazer uso adequado dos conteúdos e da informação que o matk oferece no site e com caráter enunciativo, mas não limitativo:" +
    ...
    "C) Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) do matk, de seus fornecedores ou terceiros, para introduzir ou disseminar vírus informáticos ou quaisquer outros sistemas de hardware ou software que sejam capazes de causar danos anteriormente mencionados." +
    "Mais informações" +
