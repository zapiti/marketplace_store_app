                                  ...
                                  onPressed: () {
                                    ...
                                    if (!CNPJValidator.isValid(
                                      ...
                                      Utils.showSnackbar(context,
                                        ...
                                        .responsableController.text.isEmpty) {
                                      setState(() {
                                        errorResponsable =
                                      ...
                                      setState(() {
                                        errorDescription = "Descrição não pode ser vazio";
                                      });
                                    } else if (bloc
                                    ...
                                    } else if (bloc.zipCodeController.text.isEmpty ||
                                        bloc.addressController.text.isEmpty ||
                                        bloc.numberController.text.isEmpty ||
                                        bloc.neighborhoodController.text.isEmpty ||
                                        bloc.cityController.text.isEmpty ||
                                        bloc.numberController.text.isEmpty ||
                                        bloc.stateController.text.isEmpty) {
                                      Utils.showSnackbar(
                                          context, "Endereço é obrigatório");
                                    } else {
                                      Modular.to.pushNamed(ConstantsRoutes.CALL_REGISTRE_EMAIL);
                                    }
                                  },
                                ),
                              ),
